...
<template>
  <div class="detail">
    <Drawer :mask-closable="false" :title="detailInfo.FullName + '提交的请假申请'" @on-close="loadTable" width="560" v-model="modalImport">
      <div class="detailModel">
        ...
        <ul class="leave-list">
          ...
          <li
            class="info-item"
            v-if="tableType==='approval' && detailInfo.JudgeCanOperation && isFrom === 1"
            >
            <Form ref="caseForm"  label-position="top" class="edit-form">
                <FormItem label="审批意见" prop="Option" labelFor="Option">
        ...
        <div
          v-if="isFrom === 1 && tableType==='approval' && detailInfo.JudgeCanOperation"
          style="margin-top:20px;text-align: left;"
          >
