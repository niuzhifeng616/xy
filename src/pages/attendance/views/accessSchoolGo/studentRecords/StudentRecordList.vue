   ...
   <div class="xy-content-module">
    <div class="xy-content-title xy-flex xy-between xy-center">
      <Row :gutter="10" class="title-top">
        ...
        <i-col  span="3">
          <Select v-model="areaRange" @on-change="reLoadTable" placeholder="请选择区间">
        ...
        <i-col  span="3">
          <Select v-model="state" @on-change="reLoadTable" placeholder="请选择考勤状态">
    ...
    methods: {
      ...
      allExport () {
        this.xy.downFile(
          ...
          `${this.apiPath}/api/ProgrammeRecord/StudentRecordReport`,
          {
      ...
      async getTableRecordList (row) {
        ...
        if (rs.success) {
          this.recordsData = rs.data !== null ? rs.data : []
        }
      },
      ...
      async getTableList () {
        ...
        if (rs.success) {
          this.tableData = rs.data.data !== null ? rs.data.data : []
