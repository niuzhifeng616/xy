<template>
  ...
  <div class="xy-content-body">
    ...
    <div>
      <div v-if="leftEmpty && rightEmpty" class=" no-data-box">
  ...
  export default {
    ...
    methods: {
      ...
      getTP () {
        ...
        this.xy
          .get(`${this.$store.state.apiPath}/api/AttStatistics/GetForYear`, {
            SchoolDistrictID: this.schoolDistrictID,
            GradeYearID: this.gradeYearID,
            ApplicationID: this.applicationID,
            ApplicationSubMenuID: this.applicationSubMenuID,
      ...
      // 点击详情跳转到年级页面
      toAttStatClass (row) {
        this.$parent.defaultValue.push(row.StatisticsID)
        this.$parent.comName = 'AttAdminClassForClass'
      ...
      exportModal () {
        if (this.pagination.total !== 0) {
          ...
          this.xy.downFile(
            `${this.$store.state.apiPath}/api/AttStatistics/ExportForYear`
            ,
            {
              SchoolDistrictID: this.schoolDistrictID,
              GradeYearID: this.gradeYearID,
