<template>
  ...
  <div class="xy-content-body">
    ...
    <div>
      ...
      <div class=" no-data-box" v-else-if="!tableLoading && leftEmpty && rightEmpty">
        <img class="no-data-img" src="@/assets/common/nullData.svg" />
        <span class="no-data-text" v-cloak>该搜索条件下没有结果。</span>
      </div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      getTP () {
        ...
        this.xy.get(
          `${this.$store.state.apiPath}/api/AttStatistics/GetForSchool`,
          {
            SchoolDistrictID: this.schoolDistrictID,
            ApplicationID: this.applicationID,
            ApplicationSubMenuID: this.applicationSubMenuID,
      ...
      toAttStatGrade (row) {
        ...
        this.$parent.comName = 'AttAdminClassForGrade'
      ...
      exportModal () {
        if (this.pagination.total !== 0) {
          ...
          this.xy.downFile(
            `${this.$store.state.apiPath}/api/AttStatistics/ExportForSchool`,
            {
              SchoolDistrictID: this.schoolDistrictID,
              ApplicationID: this.applicationID,
              ApplicationSubMenuID: this.applicationSubMenuID,
