    ...
    <div class="leaveBody" v-if="!leftEmpty || !rightEmpty">
      ...
      <div class="tableWidthControl">
            <XyAntTable
              ...
              <!-- 姓名 -->
              <div slot="StatisticsName" style="min-width: 140px" slot-scope="text, record">
  ...
  export default {
    ...
    methods: {
      ...
      getTP () {
        ...
        this.xy
          .get(
            `${this.$store.state.apiPath}/api/ClassAttStatistics/GetForClass`,
            {
              SchoolDistrictID: this.schoolDistrictID,
              GradeYearID: this.gradeYearID,
              DisciplineID: this.disciplineID,
      ...
      backLevel () {
        ...
        this.$parent.comName = 'AttTeachingClassForDiscipline'
      },
      // 前一天/周/月
      before () {
      ...
      exportModal () {
        if (this.pagination.total !== 0) {
          ...
          this.xy.downFile(
            `${this.$store.state.apiPath}/api/ClassAttStatistics/ExportForClass`
            ,
            {
              SchoolDistrictID: this.schoolDistrictID,
              GradeYearID: this.gradeYearID,
