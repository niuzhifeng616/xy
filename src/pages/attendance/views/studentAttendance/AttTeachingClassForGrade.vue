      ...
      <div class="tableWidthControl">
        <XyAntTable
          ...
          <div slot="StatisticsName" slot-scope="text, record">
            <span class="table-el-hover" @click="toAttStatDiscipline(record)">
          ...
          <div slot="Action" slot-scope="text, record">
            <a @click="toAttStatDiscipline(record)"> 详情 </a>
          </div>
        </XyAntTable>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 点击详情跳转到班级页面
      toAttStatDiscipline (row) {
        this.$parent.defaultValue.push(row.DisciplineID.toString())
      ...
      backLevel () {
        ...
        this.$parent.comName = 'AttTeachingClassForSchool'
      },
      // 前一天/周/月
      before () {
