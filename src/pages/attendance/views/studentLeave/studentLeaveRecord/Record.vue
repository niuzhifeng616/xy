  ...
  <div class="xy-content-module">
    <div class="xy-content-title clearfix">
        <div class="pr selTop">
          <div>
            <span>校区/年级/班级：</span>
            <Cascader :data="cascader" v-model="defaultValue" change-on-select class="fl" @on-change="cascaderChange" :clearable="false" style="width:272px;"></Cascader>
          </div>
          <div>
              <span>
                  请假学生：
              </span>
              <i-input clearable v-model="searchNames" placeholder="用户名/姓名" style="width: 200px;margin-right:15px">
              </i-input>
          </div>
          <div>
            <span>
            ...
            <date-picker :value="dates" separator="~" format="yyyy/MM/dd" type="daterange" split-panels
                placeholder="开始时间-结束时间" @on-change="dateChange" style="width: 200px; margin-left:0px;"
        ...
        <div class="pr selBottom">
            <span>类型：</span>
            <i-select v-model="leaveTypeID" class=" xy-content-title-search" style="width:200px;"
            ...
            <span>状态：</span>
            <i-select v-model="approvalStateID" class=" xy-content-title-search" style="width:200px;"
            ...
            <span>是否离校：</span>
            <i-select v-model="leaveID" class=" xy-content-title-search" style="width:200px;"
    ...
    <div class="xy-content-body">
        ...
        >
          ...
          <div slot="UserNameRender" style="min-width: 100px" slot-scope="text, record">
            <span class="table-el-hover" @click="look(record)">
              {{record.StudentName}}
            </span>
          </div>
          <div slot="IsLeaveSchool" slot-scope="text, record">
              {{record.IsLeaveSchool ? '是' : '否'}}
          </div>
...
<script>
  ...
  import ApplyLook from '@/pages/attendance/components/studentLeave/ApplyLookNew.vue'
  export default {
    components: {
      XyAntTable,
      ApplyLook
        ...
        this.xy.get(`${this.$store.state.apiPath}/api/StudentLeave/GetPage`,
          ...
          if (res.success) {
            ...
            that.columns = [
              ...
              {
                title: '是否离校',
                dataIndex: 'IsLeaveSchool',
                width: 100,
                scopedSlots: { customRender: 'IsLeaveSchool' }
              },
              {
                title: '申请人',
