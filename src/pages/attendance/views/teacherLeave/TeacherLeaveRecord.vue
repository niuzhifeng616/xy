  ...
  <div class="xy-content-module">
      <div class="xy-content-title clearfix">
        <Row :gutter="10">
          ...
          <i-col span="3">
            <i-select v-model="leaveType" @on-change="reLoadTable" placeholder="请假类型">
              <i-option :value="0">
                所有类型
              </i-option>
              <i-option
          ...
          <i-col span="3">
            <i-select v-model="state" @on-change="reLoadTable" placeholder="请假状态">
              <i-option
    ...
    methods: {
      ...
      async loadTable () {
        ...
        let res = await this.xy.get(
          this.$store.state.apiPath + '/api/TeacherLeave/GetRecordPageList', params)
        if (res.success) {
