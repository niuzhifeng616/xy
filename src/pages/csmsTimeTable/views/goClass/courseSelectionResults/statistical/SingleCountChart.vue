    ...
    <div style="width: 92%;margin: 0 auto;"
      ...
      <XyAntTable :isPage="false"
        ...
        <div slot="SCount"
              ...
              <span v-if='!record.isSumRow'>{{record.StudentOrganizationFullName +'(' + record.SCount + '人)'}}</span>
  ...
  export default {
    ...
    methods: {
      async getTable () {
        ...
        this.dataTable = []
        this.xy.loading()
        let res = await this.xy.post(`${this.$store.state.apiPath}/api/MovingClassSubjectSetting/GetMovingClassSingleSelectInfo`, {
