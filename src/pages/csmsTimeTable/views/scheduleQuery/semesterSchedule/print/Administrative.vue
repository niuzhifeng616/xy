                  ...
                  <tr v-for="sectionTd in festList"  :key="sectionTd.AMorPMOrderName">
                      ...
                      <template v-for="week in weekData">
                          ...
                          <template v-for="crouse in item.SloverResultList">
                              ...
                              <!-- 教师 -->
                              <div v-if="isShwowTeacher&&crouse.TeacherFullName!=null">
                                  <p class="nowrap other-name" v-if="crouse.TeacherFullName.length>10">{{crouse.TeacherFullName.substr(0,9)}}..</p>
                                  <p class="nowrap other-name" v-if="crouse.TeacherFullName.length<11">{{crouse.TeacherFullName}}</p>
                              </div>
                              <!-- 教学楼 -->
