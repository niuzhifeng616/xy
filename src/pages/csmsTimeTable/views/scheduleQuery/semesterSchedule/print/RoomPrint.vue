...
<div class="print-body">
    <div class="fix-down" v-if="isShowDown" @click="downPDF">打印课表</div>
      <div v-for="item in datatable" :key="item.FullName"
            :style="{'height':isShwowTeacher&&isShwowClass?'1140px':'558px','marginBottom':'40px'}">
                      ...
                      <template v-for="week in weekData">
                          ...
                          <template v-for="crouse in item.SloverResultList">
                              ...
                              <!-- 课程 -->
                                ...
                                <!-- 教学楼 -->
                                <div v-if="isShwowClass&&crouse.ClassName!=null">
                                    <p class="nowrap other-name" v-if="crouse.ClassName.length>10">{{crouse.ClassName.substr(0,9)}}..</p>
                                    <p class="nowrap other-name" v-if="crouse.ClassName.length<11">{{crouse.ClassName}}</p>
                                </div>
                          </div>
                          </template>
                      </td>
