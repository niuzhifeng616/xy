<template>
  ...
  <div class="xy-content-body">
    ...
    <table id="tbClassTableTime" class="class-hour-table" style="width:100%;">
        ...
        <tbody>
            <tr v-for="(timeTable,index) in timeTableData" :key="index" v-show="timeTable.isShow">
    ...
    <Modal v-model="modalQuicklySetting"
        ...
        <div style="font-size:14px;">
            ...
            <div class="set-section" v-if="isShowMS">
                ...
                <div>
                    <span>开始上课时间:</span>
                    <TimePicker format="HH:mm" style="margin:0 10px"
                                v-model="MSStartTime"
                                :editable="false"
                                placeholder="请选择上课时间"
                                class="time-picker"
                    ...
                    <span>每节课时长:</span>
                    <Input clearable v-model="MSLength" style="width: 100px;margin:0 10px" autofocus />
                    <span>分钟</span>
                </div>
            </div>
            <!-- 上午 -->
            <div class="set-section" v-if="isShowAM">
                ...
                <div>
                    ...
                    <span>每节课时长:</span>
                    <Input clearable v-model="AMLength" style="width: 100px;margin:0 10px" autofocus />
                    <span>分钟</span>
                    <span v-if="isShowAB">
                        <span style="margin-left:10px">大课间时长:</span>
                        <Input clearable v-model="ABRecessLength" style="width: 100px;margin:0 10px" autofocus />
                        <span>分钟</span>
                    </span>
                </div>
            </div>
            ...
            <div class="set-section" v-if="isShowPM">
                ...
                <div>
                    ...
                    <TimePicker format="HH:mm" style="margin:0 10px"
                                ...
                                class="time-picker"></TimePicker>
                    <span>每节课时长:</span>
                    <Input clearable v-model="PMLength" style="width: 100px;margin:0 10px" autofocus />
                    <span>分钟</span>
                    <span v-if="isShowPB">
                        <span style="margin-left:10px">大课间时长:</span>
                        <Input clearable v-model="PBRecessLength" style="width: 100px;margin:0 10px" autofocus />
                        <span>分钟</span>
                    </span>
                </div>
            </div>
            ...
            <div class="set-section" v-if="isShowES">
                ...
                <div>
                    ...
                    <span>
                        <span>每节课时长:</span>
                        <Input clearable v-model="ESLength" style="width: 100px;margin:0 10px" autofocus />
                        <span>分钟</span>
                    </span>
                </div>
            </div>
            ...
            <div class="set-section">
                <span>普通课间时长:</span>
                <Input clearable v-model="commonLength" style="width: 100px;margin:0 10px" autofocus />
                <span>分钟</span>
            </div>
        </div>
        <div slot="footer">
...
<script>
  export default {
    ...
    methods: {
        ...
        if (this.isOperation === 0) {
          ...
          if (res.success) {
            ...
            if (val === 0) {
              ...
              this.$store.commit('common/getParam', { pro: 'takeLessons', step: 2 }) // 校本排课（抢课）。跳转至第三步：选课学生。 takeLessons要返回的路由
              this.$router.push({
                path: '/xyhome/takeLessonsStepsHeader/arrangingStudents',
      ...
      // 快速复制
      async GetSettingList () { // 快速复制
        this.xy.loading()
        let res = await this.xy.get(`${this.$store.state.apiPath}/api/ClassTableTime/GetSettingList`, { classTableID: this.classTableID })
        if (res.success) {
          let resData = res.data
          this.quicklySetData = {
            General: [],
