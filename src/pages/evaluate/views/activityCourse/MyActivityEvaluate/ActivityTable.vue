  ...
  export default {
    ...
    methods: {
      ...
      evaluateEntry (row) {
        ...
        this.$store.commit('common/getParam', { id: row.ActivityCourseProjectID })
        this.$router.push({
          path: '/xyhome/myActivityEva',
      ...
      async loadTable () {
        ...
        let res = await this.xy.get(`${this.$store.state.apiPath}/api/ActivityCourseProject/GetStudentProjectByPage`, obj)
        if (res.success) {
