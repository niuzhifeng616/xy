    ...
    <div class='xy-content-body'>
      ...
      >
        ...
        <FormItem
          ...
          prop="Screenshot"
        >
          <div class="uploadImgBox" :class="formValidate.Screenshot.length === 0 ? '' : 'haveImg'"  v-if="!rowObj.isApproal">
            <a-upload-dragger
          ...
          <div class="uploadImgBox"  :class="formValidate.Screenshot.length === 0 ? '' : 'haveImg'" v-else>
            <ul>
              <li
                v-for="(item, index) in formValidate.Screenshot"
                :key="index"
...
<script>
  export default {
    ...
    created () {
      ...
      this.rowObj = this.$store.state.evaluate.honorObj
