  ...
  <div class="details-wrap">
    ...
    <div class="approval-cont">
      <Form label-position="top" class="details-info">
        ...
        <FormItem label="发布照片">
          <div style="width: 460px; margin-top: 50px; overflow:hidden;">
            <div v-for="item in PhotoList" :key="item.DownloadLink"
                 style="width: 220px; height:150px; float: left; margin: 0 10px 10px 0; border:1px solid rgba(236,238,241,1);background:#fff;border-radius:6px;">
              <img v-bind:src="item.DownloadLink" style="width:100%; max-height:150px;"/>
            </div>
          </div>
        </FormItem>
        ...
        <div v-else class="edit">
          ...
          <FormItem label="审批意见" labelFor="appCont">
            <span>
    ...
    methods: {
      ...
      async GetPublicApproveById () {
        ...
        if (rs.success) {
          ...
          this.PhotoList = rs.data.PhotoList
        }
      },
