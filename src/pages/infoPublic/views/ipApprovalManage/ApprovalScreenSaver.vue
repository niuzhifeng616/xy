  ...
  <div class="details-wrap">
    ...
    <div class="approval-cont">
      <Form label-position="top" class="details-info">
        ...
        <FormItem label="标题">
        <span>
            {{ScreenSaverModel.ScreenSaverName}}
        </span>
        </FormItem>
        <FormItem label="发布内容">
          <i-col span="24">
            <div class="welcome-preview-bg"
                 v-bind:style="{backgroundImage:welcomeBgExample,height:ScreenSaverModel.ScreenMode==1?'700px':''}">
            </div>
          </i-col>
        </FormItem>
        <FormItem label="发布时间">
        <span style="font-size:14px;">
            ...
            <span style="vertical-align:middle;">
                {{xy.moment(ScreenSaverModel.StartDate).format('YYYY-MM-DD HH:mm')}} -
                {{xy.moment(ScreenSaverModel.EndDate).format('YYYY-MM-DD HH:mm')}}
            </span>
        </span>
        </FormItem>
    ...
    methods: {
      ...
      async GetPublicApproveById () {
        ...
        if (rs.success) {
          ...
          this.ScreenSaverModel = rs.data.ScreenSaverModel
          // this.ScreenSaverModel = rs.data.BackgroundDLink

          let strurl = this.ScreenSaverModel.ScreenThumbnail
