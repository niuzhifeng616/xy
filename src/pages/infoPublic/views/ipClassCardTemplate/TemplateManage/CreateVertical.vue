  ...
  <div class="xy-content-body pr">
      <div class="clearfix">
          <div class="fl">
              ...
              <i-input v-model="TemplateName" v-cloak style="width:200px;margin-right:10px;" maxlength="10"></i-input>
              <span style="padding-top: 4px;">模板简介：</span>
              <i-input v-model="TemplateDescribe" v-cloak style="width:300px;" maxlength="30"></i-input>
      ...
      <div class="tamplet-box-container-vertical" id="tamplet-box">
          ...
          <div class="tamplate-box-right-vertical">
                  ...
                  <div v-for="(item,index) in dragList" :key="index"  v-cloak>
                      ...
                      <div class="dragebox-template-vertical">
                          <div v-for="(drags,index) in item.model"
                                ...
                                @dragend="dragend">
                              <div class="pr">
                                  <img :src="require('@/assets/common/infoPublic/classCard/vertical/'+drags.ControlImg)" :class="'dragbox-template-img-size-'+drags.ControlImgStyle+'-vertical'" class="cursor-grab" :style="{border: skinN === 'fcl' ? '1px solid #e9e9e9' : '',borderRadius: skinN === 'fcl' ? '8px' : ''}" />
  ...
  export default {
    ...
    mounted () {
      ...
      this.$nextTick(() => {
        ...
        // bg.style.backgroundImage = 'url(' + that.apiPath + '/image/classCard/df.png)'
        that.$nextTick(function () {
          that.windowResize()
          /// xy.breadcrumb.create({ name: '新建竖版模板' })
        ...
        $('#templateModule').on('click', '.del-template-img-vertical', function () {
          ...
          for (var i = 0; i < that.addTemplateList.length; i++) {
            console.log(Number($(this).attr('data-indexs')))
    ...
    methods: {
      ...
      windowResize () {
        var pDom = document.getElementById('tamplet-box')
        var pL = pDom.offsetLeft
        var pT = pDom.offsetTop
        ...
        for (var i = 0; i < doms.length; i++) {
          // console.log(doms[i].offsetLeft + ',' + pL + ',' + doms[i].offsetWidth)
      ...
      async Create (result) {
        let res = await this.xy.post(
          this.apiPath + `/api/Template/Create`, {
