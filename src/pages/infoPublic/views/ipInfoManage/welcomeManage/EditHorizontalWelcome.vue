    ...
    <div class="xy-content-body">
        <div style="display:flex;justify-content:flex-start;margin-bottom: 60px;">
            <div style="overflow-x:auto">
                <Button type="primary" :disabled="row._disabled" icon="ios-add" @click="addTextBox">添加文本框</Button>
    ...
    methods: {
      ...
      async submitCreat () {
        ...
        for (let i = 0; i < this.boxData.length; i++) {
          ...
          console.log(parseInt($('' + temp1 + '').offset().left), welcomeBgX)
          arr.push({
            FontFamily: 0,
      ...
      async UploadScreenSaverThumbnail (arr, adress) {
        ...
        let c = await that.xy.post(
          that.apiPath + `/api/Resource/EditScreenSaver`, {
            ...
            StartDate: that.times[0],
            EndDate: that.times[1],
            Contents: arr
          }
        )
        that.xy.unloading()
