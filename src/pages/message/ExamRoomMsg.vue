  ...
  <div class="xy-content-module"  id="XyContentModuleReplace">
    <div class="xy-content-body">
        <div class="MyInvigilate_body">
            <div class="fr pr">
                <!-- 学年学期 -->
                <cascader v-model="searchDefaultValue" :data='defaultList' class="fl xy-content-title-search" not-found-text="暂无数据" @on-change="cascaderFunDefault"
            ...
            <div v-if='list.length==0' v-cloak class="no-data-box">
                ...
                <span class="no-data-text">暂无监考</span>
            </div>
...
<script>
  export default {
    ...
    mounted () {
      $('div.msg-detail').attr('id', 'msg-detail')
    },
    beforeDestroy () {
      $('div.msg-detail').remove('id', 'msg-detail')
    },
    methods: {
      // 选择考试
      SemesterChange (a) {
...
.MyInvigilate_body {
  ...
  .MyInvigilate_body > header {
    ...
    width: 236px;
    height: 45px;
    background-image: url(../educationAffairs/views/eaExamRoomManage/Image/header.png);
  }
...
.MyInvigilate_sub {
  ...
  .MyInvigilate_body_content > div:nth-child(odd) > p {
    background-image: url(../educationAffairs/views/eaExamRoomManage/Image/time_1.png);
  }
  ...
  .MyInvigilate_body_content > div:nth-child(even) > p {
    background-image: url(../educationAffairs/views/eaExamRoomManage/Image/time_2.png);
  }
