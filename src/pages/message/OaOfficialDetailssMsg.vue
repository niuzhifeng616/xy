<template>
  <div class="xy-content-module" id="DrawerDetails">
    <div class="detail">
      <div class="detail-top">
        <p>{{ detail.FullName }}提交的公文</p>
      ...
      <div class="detail-con">
        <div>
          <span>主题：</span>
          <div v-html="detail.OfficialDocTheme"></div>
        </div>
        <div>
          <span>公文标题：</span>
      ...
      <div class="bottom-btn"   v-if="coper != 'cc' && detail.JudgeCanOperation === true">
        <Button
        ...
        <Button
          ...
          @click="approvalFun(3)"
          :loading="isShowSpin"
          style="margin-right:30px;min-width:90px;height:36px"
        >
          拒绝
        </Button>
      </div>
...
<script>
  ...
  export default {
    ...
    watch: {
      row: {
        handler (newVal) {
          this.officeId = newVal.BusinessID
