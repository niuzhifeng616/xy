    ...
    <div class="detail">
        ...
        <div class="detail-con">
            ...
            <div v-if="detail.IsArchive">
                <span>归档日期：</span>
                <!-- <div v-cloak>{{moment(detail.LastModifyByDate).format('YYYY-MM-DD HH:mm')}}</div> -->
      ...
      <div class="bottom-btn">
           <!-- <i-button class="primary" @click="ReturnClick" ghost>关闭</i-button>-->
           <Button class="xy-btn-primary"  shape="circle" @click="ReturnClick">关闭</Button>
      </div>
    <!-- <script src="XYSubSiteLinkUrl/View/oaDocument/OfficialArchive/PC/Scripts/Detail.js"></script> -->
</div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail: function () {
        ...
        this.xy.get(`${this.$store.state.apiPath}/api/OfficialDocument/GetByID`, params).then(res => {
          this.xy.unloading()
          if (res.success) {
            var data = res.data
